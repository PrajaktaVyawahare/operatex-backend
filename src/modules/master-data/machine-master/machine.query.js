...
GET_CAPABILITY_CONFIG: `
    SELECT
        ...
        mc.created_at,
        mc.updated_at
    FROM machine_capability_config mc
    INNER JOIN machine_master mm
        ON mc.machine_id = mm.machine_id
    ORDER BY
        mm.machine_name,
        mc.capability_name;
`,
...
GET_GROUP_CONFIG: `
    SELECT
        ...
        mg.created_at,
        mg.updated_at
    FROM machine_group_config mg
    INNER JOIN machine_master mm
        ON mg.machine_id = mm.machine_id
    ORDER BY
        mm.machine_name,
        mg.group_name;
`,
    ...
    UPDATE_CAPABILITY: `
        UPDATE machine_capability_config
        SET
            machine_id = $2,
            capability_name = $3,
            capability_value = $4,
