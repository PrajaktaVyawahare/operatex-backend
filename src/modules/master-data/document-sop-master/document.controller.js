// src/modules/document-sop-master/document.controller.js

const service = require("./document.service");
const validation = require("./document.validation");
...
async function getMaster(req, res, next) {
    ...
    try {
        ...
        res.json({
            ...
            message:
                "Document master fetched successfully.",
...
async function execute(req, res, next) {
    ...
    try {
        ...
        res.json({
            ...
            message:
                "Document event executed successfully.",
